...
export default function Certifications() {
  return (
    <section id="certifications" className="mx-auto max-w-7xl px-6 py-28">
      <div className="mb-14"><p className="font-mono text-xs text-cyan-400">05 — CERTIFICATIONS</p><h2 className="mt-4 font-display text-4xl font-bold sm:text-5xl">Certifications &<br /><span className="text-slate-500">Learning</span></h2></div>
