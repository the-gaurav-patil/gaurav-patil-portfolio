...
export default function Skills() {
  return (
    <section id="skills" className="mx-auto max-w-7xl px-6 py-28">
      <div className="mb-14"><p className="font-mono text-xs text-cyan-400">SKILLS</p><h2 className="mt-4 font-display text-4xl font-bold sm:text-5xl">Technical<br /><span className="text-slate-500">Toolkit</span></h2></div>
